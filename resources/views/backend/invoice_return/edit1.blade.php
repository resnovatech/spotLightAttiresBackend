...
@section('title')
Edit Return Invoice information | {{ $ins_name }}
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Edit Return Invoice Generate</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">

                        <li class="breadcrumb-item active"> Edit Return Invoice</li>
                    </ol>
                </div>
...
<form method="POST" action="{{ route('invoice_return_update') }}">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="number" name="total_payble_price" value="{{ $invoice->grand_total }}" id="total_payble_price">
                            </div>
                        </div>
                        {{-- <div class="mb-2 row">

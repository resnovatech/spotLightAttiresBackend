 ...
 <ul class="pagination pagination-rounded justify-content-end mb-2">
    ...
    <li class="page-item disabled">
      <button  class="page-link" id="ppage_link_outOfStock"><i class="mdi mdi-chevron-left"></i></button>
  </li>
    ...
    <li class="page-item active">
      <button  class="page-link" id="page_link_outOfStock{{ $i }}">{{ $i }}</button>
  </li>
    @elseif($i == 2)
  <li class="page-item">
      <button  class="page-link" id="page_link_outOfStock{{ $i }}" >{{ $i }}</button>
...
<!--next button work -->
<li class="page-item ">
<button  class="page-link" id="npage_link_outOfStock"><i class="mdi mdi-chevron-right"></i></button>
</li>

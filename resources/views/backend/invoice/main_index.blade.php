...
<input type="text" name="order_id" placeholder="Order Id" class="form-control form-control-sm" />
    </div>

    <div class="col-sm-2 col-xl-2">
        <input type="text" name="customer_name" placeholder="Customer Name" class="form-control form-control-sm" />
    </div>
    ...
    <div class="col-sm-3 col-xl-3">
        <div class="input-daterange input-group" id="datepicker6" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker6'>
            <input type="text" class="form-control form-control-sm" name="start" placeholder="Start Date" />
            <input type="text" class="form-control form-control-sm" name="end" placeholder="End Date" />
        </div>
    </div>
...
@endif
    ...
    <p>Showing 1 to {{count($invoice_list)}}  of {{$total_data}}  entries</p>
   <!--pagination start -->

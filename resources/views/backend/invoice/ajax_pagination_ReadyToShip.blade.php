<ul class="pagination pagination-rounded justify-content-end mb-2">
    ...
    <li class="page-item disabled">
      <button  class="page-link" id="papage_linkr"> <i class="mdi mdi-chevron-left"></i></button>
  </li>

    @else
    <li class="page-item ">
      <button  class="page-link" id="papage_linkr{{ $id_for_pass }}"> <i class="mdi mdi-chevron-left"></i></button>
  </li>
  @endif
<!--end previous button work-->
    ...
    <li class="page-item active">
      <button  class="page-link" id="apage_linkr{{ $i }}">{{ $i }}</button>
  </li>
  @else
  <li class="page-item ">
      <button  class="page-link" id="apage_linkr{{ $i }}">{{ $i }}</button>
  ...
  <li class="page-item ">
      <button  class="page-link" id="apage_linkr{{ $i+1 }}">{{ $i+1 }}</button>
  </li>
  <li class="page-item ">
...
<li class="page-item disabled">
<button  class="page-link disabled" id="napage_linkr"> <i class="mdi mdi-chevron-right"></i></button>
</li>
@else
<li class="page-item ">
<button  class="page-link" id="napage_linkr{{ $id_for_pass }}"> <i class="mdi mdi-chevron-right"></i></button>
</li>
@endif

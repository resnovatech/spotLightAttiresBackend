...
<div class="row mt-2">
    <div class="col-sm-6 col-xl-6">
        <div class="d-flex flex-wrap gap-2">
            <p class="horizontal-center" >Selected:<span id="numberOfChecked_exchage"> 0</span></p>

            <button type="" id="delete_button_exchage" class="btn btn-sm btn-outline-danger waves-effect ml-4" disabled>
                Delete All
            </button>
...
$total_dataex = DB::table('exchanges')->count();
        ...
        $invoice_listex = DB::table('exchanges')->latest()->limit(10)->get();

?>
<div class="row" id="main_content_tableex">
    <div class="table-responsive">
        <table class="table align-middle table-nowrap table-check">
            ...
            <tr>
                <th style="width: 20px;" class="align-middle">
                    <div class="form-check font-size-16">
                        <input class="form-check-input " type="checkbox" id="master_exchage">
            ...
            <tbody>
                @foreach($invoice_listex as $all_invoice_list)
            <tr>
                <td>
                    <div class="form-check font-size-16">
                        <input class="form-check-input sub_chk_exchage" value="{{$all_invoice_list->id}}"  data-id="{{$all_invoice_list->id}}" type="checkbox" id="orderidcheck01">
...
@endif
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-primary btn-sm btn-rounded" data-bs-toggle="modal" data-bs-target=".orderdetailsModal1ex{{ $all_invoice_list->id }}">
                        View Details
                    </button>
                    <!-- Modal -->
<div class="modal fade orderdetailsModal1ex{{ $all_invoice_list->id }}" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
...
<div class="modal-body">
    ...
    $product_list = DB::table('exchangedetails')
...
<!-- end modal -->
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a href="{{ route('exchange_list_view',$all_invoice_list->id ) }}" class="dropdown-item"><i class="mdi mdi-eye font-size-16 text-info me-1"></i> View</a></li>
                            ...
                            @else
                            <li><a href="{{ route('exchange_list_edit',$all_invoice_list->id ) }}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                            @endif
                        ...
                        <form id="delete-form-{{ $all_invoice_list->id }}" action="{{ route('exchange_list_delete',$all_invoice_list->id) }}" method="POST" style="display: none;">
    ...
    <p>Showing 1 to {{count($invoice_listex)}} of {{$total_dataex}} entries</p>
   <!--pagination start -->
   @include('backend.invoice.normal_pagination_exchanged')
   <!--pagination end -->
    </div>

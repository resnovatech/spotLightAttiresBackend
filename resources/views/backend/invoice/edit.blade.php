...
<form method="POST" action="{{ route('invoice_list_update') }}">
    @csrf
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <select class="form-select" name="ware_house">
                            <option>Select</option>
                            <option value="SpotLightAttires" {{ $invoice->warehouse == 'SpotLightAttires' ? 'selected':'' }}>SpotLightAttires</option>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mb-2 row" id="show_order_by_price">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="number" name="order_by_amount" value="{{ $order_by_list_first->per_amount }}" >
                            </div>
                            <label for="example-text-input" class="col-md-3 col-form-label mt-1">After Order By Amount</label>
                            <div class="col-md-9">
                                <input class="form-control mt-1" type="number" name="after_order_by_amount" value="{{ $order_by_list_first->after_per_amount }}" >

                                <input class="form-control mt-1" type="hidden" name="per_type" value="{{ $order_by_list_first->per_type }}" >

                                <input class="form-control mt-1" type="hidden" name="per_name" value="{{ $order_by_list_first->per_name}}" >
                            </div>
                        </div>
                        <div class="mb-2 row">

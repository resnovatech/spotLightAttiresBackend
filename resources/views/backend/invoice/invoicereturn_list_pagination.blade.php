...
$product_list1 = DB::table('invoicereturndetails')
...
<div class="table-responsive">
    <table class="table align-middle table-nowrap">
        ...
        <tbody>
            @foreach($product_list1 as $all_product_list)
<?php
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        @endif
                        @if (Auth::guard('admin')->user()->can('invoice_return_delete'))
...
<!--pagination start -->
@include('backend.invoice.ajax_pagination_return')
<!--pagination end -->

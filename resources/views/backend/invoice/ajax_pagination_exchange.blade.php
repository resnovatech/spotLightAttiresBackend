<ul class="pagination pagination-rounded justify-content-end mb-2">
    ...
    <li class="page-item disabled">
      <button  class="page-link" id="papage_linkex"> <i class="mdi mdi-chevron-left"></i></button>
  </li>

    @else
    <li class="page-item ">
      <button  class="page-link" id="papage_linkex{{ $id_for_pass }}"> <i class="mdi mdi-chevron-left"></i></button>
  </li>
  @endif
<!--end previous button work-->
    ...
    <li class="page-item active">
      <button  class="page-link" id="apage_linkex{{ $i }}">{{ $i }}</button>
  </li>
  @else
  <li class="page-item ">
      <button  class="page-link" id="apage_linkex{{ $i }}">{{ $i }}</button>
  ...
  <li class="page-item ">
      <button  class="page-link" id="apage_linkex{{ $i+1 }}">{{ $i+1 }}</button>
  </li>
  <li class="page-item ">
...
<li class="page-item disabled">
<button  class="page-link disabled" id="napage_linkex"> <i class="mdi mdi-chevron-right"></i></button>
</li>
@else
<li class="page-item ">
<button  class="page-link" id="napage_linkex{{ $id_for_pass }}"> <i class="mdi mdi-chevron-right"></i></button>
</li>
@endif

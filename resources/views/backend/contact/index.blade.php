...
<div class="row">
    ...
    <div class="col-12">
        ...
        <p class="card-title-desc">You can <code>Show, Hide & Edit</code> all Contact</p>
    </div>
</div>
<!-- search bar --->
<div class="row">
...
<div class="row mt-2">
    ...
    <div class="col-sm-6">
        <div class="text-sm-end">
            <button type="button"
                ...
                <i class="mdi mdi-plus me-1"></i> Add New Contact Info
            </button>
        </div>
            <!-- Modal -->
    ...
    <div class="modal-body">
        <form class="mt-3" method="Post" action="{{ route('contact_us_store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input  type="text" name="icon"  class="form-control" id="image"/>
                    </div>
                </div>
...
@endforeach
                ...
                @include('backend.contact.normal_pagination')
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="{{ asset('/') }}public/custom_js/contact_page.js"></script>

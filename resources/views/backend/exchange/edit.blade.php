...
@section('title')
Exchange Invoice information | {{ $ins_name }}
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">New Exchange Generate</h4>
...
<form method="POST" action="{{ route('exchange_list_update') }}">
    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" type="text" name="order_id" value="{{ $invoice->order_id }}" id="">
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <table class="table align-middle table-nowrap table-check" id="dynamicAddRemove">
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                ...
                                <select class=" form-control main_product_id" name="main_product_id[]" id="main_product_id{{ $key+5000 }}" >
                            ...
                            <td style="width: 100px; max-width:100px; min-width:100px;">
                                <select class=" form-control main_product_size" name="main_product_size[]" id="main_product_size{{ $key+5000 }}" >
                            ...
                            <td style="width:100px; max-width:100px; min-width:100px;">
                                <select class=" form-control main_product_color" name="main_product_color[]" id="main_product_color{{ $key+5000 }}" >
                            ...
                            <td>
                                <input type="hidden" id="exchange_option{{ $key+5000 }}"  name="exchange_option[{{ $key }}]" value="0"  />
                                <input type="checkbox" id="exchange_option{{ $key+5000 }}"  name="exchange_option[{{ $key }}]" value="1"  />
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="number" name="cash_on_delivery_id" value="{{ $invoice->cod }}" id="cash_on_delivery_id">
                            </div>
                        </div> --}}
                        <div class="card mt-3">
...
$("[id^=exchange_option]").change(function(){

var main_id = $(this).attr('id');
    var get_id_from_main = main_id.slice(15);


    if ($("#exchange_option"+get_id_from_main).is(':checked')){

        $("#exchange_option"+get_id_from_main).val(1);

    }else{
        $("#exchange_option"+get_id_from_main).val(0);

        ...
        <div class="card">
            <div class="card-body">
                <div class="button-items justify-content-center">
                    ...
                    @else
                    <a href="{{ route('exchange_list_edit',$invoice->id) }}" class="btn btn-primary waves-effect waves-light"><i class="fas fa-pen"></i> Edit Invoice
                    </a>


@endif

                    <a href="{{ route('exchange_list_print',$invoice->id) }}" class="btn btn-info waves-effect waves-light"><i class="fas fa-print"></i> Print
                    </a>
                    ...
                    <form id="delete-form-{{ $invoice->id }}" action="{{ route('exchange_list_delete',$invoice->id) }}" method="POST" style="display: none;">

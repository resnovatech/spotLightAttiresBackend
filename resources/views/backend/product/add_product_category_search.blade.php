...
<li  data-catname="{{ $all_category_list->cat_name }}" id="category_name{{ $key+1 }}" class="dynamic_cat">{{ $all_category_list->cat_name }}<span> <i class="bx bx-right-arrow-alt"></i> </span>
</li>

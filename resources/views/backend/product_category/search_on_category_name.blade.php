...
@endforeach
    ...
    <ul class="pagination pagination-rounded justify-content-end mb-2">
        ...
        <li class="page-item disabled">
          <button  class="page-link" id="sppage_link"><i class="mdi mdi-chevron-left"></i></button>
      </li>
...
<!--next button work -->
<li class="page-item ">
<button  class="page-link" id="snpage_link"><i class="mdi mdi-chevron-right"></i></button>
</li>

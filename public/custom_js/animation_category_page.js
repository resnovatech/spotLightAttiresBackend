$(document).ready(function () {
   ...
   $('#search_on_cat_name').on('keyup', function () {
    ...
    $.ajax({
    url: "animation_category_pagination_start_search",
    type: "GET",
...
$.ajax({
url: "animation_category_pagination_start_delete",
method: 'GET',
...
$.ajax({
url: "brand_ajax_multiple_select",
method: 'GET',
data: {numberOfSubChecked:numberOfSubChecked},
success: function(data) {
   // $("#myModal").modal('hide');
...
$.ajax({
url: "brand_ajax_multiple_select_active",
method: 'GET',
data: {numberOfSubChecked:numberOfSubChecked},
success: function(data) {
   // $("#myModal").modal('hide');

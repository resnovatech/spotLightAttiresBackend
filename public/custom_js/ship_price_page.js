$(document).ready(function () {
 ...
 $('#search_on_cat_name').on('keyup', function () {
  ...
  $.ajax({
  url: "shipping_price_list_pagination_start_search",
  type: "GET",
...
$.ajax({
url: "shipping_price_list_pagination_start_delete",
method: 'GET',
...
$("[id^=page_link]").click(function(){
  ...
  $.ajax({
  url: "shipping_price_list_pagination_start",
  method: 'GET',
  ...
  $("[id^=apage_link]").click(function(){
      ...
      // var token = $("input[name='_token']").val();
      $.ajax({
      url: "shipping_price_list_pagination_start_search_ajax",
      method: 'GET',
